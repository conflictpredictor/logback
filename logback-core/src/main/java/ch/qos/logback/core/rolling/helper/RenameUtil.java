...
public
  class
  RenameUtil  extends ContextAwareBase
 {
     ...
     */
    // START rename(String-String-String-String)//public void rename(String src, String target) throws RolloverFailure {
...
// END rename(String-String-String-String)//  }
    ...
    // START renameByCopying(String-String-String-String)//public void renameByCopying(String src, String target)
          throws RolloverFailure {
...
// END renameByCopying(String-String-String-String)//  }
	

    // START createMissingTargetDirsIfNecessary(File-File)//void createMissingTargetDirsIfNecessary(File toFile) throws RolloverFailure {
...
// END createMissingTargetDirsIfNecessary(File-File)//  }

...
public
  ...
  implements AppenderAttachable<E>
 {
     ...
     */
    // START isDiscardable(E-E)//protected boolean isDiscardable(E eventObject) {
    return false;
// END isDiscardable(E-E)//  }
     ...
     * @param eventObject
     */
    // START preprocess(E-E)//protected void preprocess(E eventObject) {
// END preprocess(E-E)//  }
...
// END append(E-E)//  }
    ...
    // START isQueueBelowDiscardingThreshold({FormalParametersInternal})//private boolean isQueueBelowDiscardingThreshold() {
    return (blockingQueue.remainingCapacity() < discardingThreshold);
// END isQueueBelowDiscardingThreshold({FormalParametersInternal})//  }
    ...
    // START getQueueSize({FormalParametersInternal})//public int getQueueSize() {
    return queueSize;
// END getQueueSize({FormalParametersInternal})//  }
	

    // START setQueueSize(int-int)//public void setQueueSize(int queueSize) {
    this.queueSize = queueSize;
// END setQueueSize(int-int)//  }
	

    // START getDiscardingThreshold({FormalParametersInternal})//public int getDiscardingThreshold() {
    return discardingThreshold;
// END getDiscardingThreshold({FormalParametersInternal})//  }
	

    // START setDiscardingThreshold(int-int)//public void setDiscardingThreshold(int discardingThreshold) {
    this.discardingThreshold = discardingThreshold;
// END setDiscardingThreshold(int-int)//  }
	

    // START getMaxFlushTime({FormalParametersInternal})//public int getMaxFlushTime() {
    return maxFlushTime;
// END getMaxFlushTime({FormalParametersInternal})//  }
	

    // START setMaxFlushTime(int-int)//public void setMaxFlushTime(int maxFlushTime) {
    this.maxFlushTime = maxFlushTime;
// END setMaxFlushTime(int-int)//  }
     ...
     */
    // START getNumberOfElementsInQueue({FormalParametersInternal})//public int getNumberOfElementsInQueue() {
    return blockingQueue.size();
// END getNumberOfElementsInQueue({FormalParametersInternal})//  }
     ...
     */
    // START getRemainingCapacity({FormalParametersInternal})//public int getRemainingCapacity() {
    return blockingQueue.remainingCapacity();
// END getRemainingCapacity({FormalParametersInternal})//  }
...
// END iteratorForAppenders({FormalParametersInternal})//  }
    ...
    // START getAppender(String-String)//public Appender<E> getAppender(String name) {
    return aai.getAppender(name);
// END getAppender(String-String)//  }
	

    // START isAttached(Appender<E>-Appender<E>)//public boolean isAttached(Appender<E> eAppender) {
...
// END detachAndStopAllAppenders({FormalParametersInternal})//  }
    ...
    // START detachAppender(Appender<E>-Appender<E>)//public boolean detachAppender(Appender<E> eAppender) {

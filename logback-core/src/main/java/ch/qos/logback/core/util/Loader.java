...
public
   ...
   */
     ...
     */
    // START getResource(String-String-ClassLoader-ClassLoader)//public static URL getResource(String resource, ClassLoader classLoader) {
    try {
      return classLoader.getResource(resource);
    } catch (Throwable t) {
      return null;
    }
// END getResource(String-String-ClassLoader-ClassLoader)//  }
     ...
     * @return
     */
    // START getResourceBySelfClassLoader(String-String)//public static URL getResourceBySelfClassLoader(String resource) {
    return getResource(resource, getClassLoaderOfClass(Loader.class));
// END getResourceBySelfClassLoader(String-String)//  }
     ...
     * <code>null<code>.
     */
    // START getTCL({FormalParametersInternal})//public static ClassLoader getTCL() {
    return Thread.currentThread().getContextClassLoader();
// END getTCL({FormalParametersInternal})//  }
	

    // START loadClass(String-String-Context-Context)//public static Class<?> loadClass(String clazz, Context context)
          throws ClassNotFoundException {
    ClassLoader cl = getClassLoaderOfObject(context);
    return cl.loadClass(clazz);
// END loadClass(String-String-Context-Context)//  }
     ...
     * @return
     */
    // START getClassLoaderOfObject(Object-Object)//public static ClassLoader getClassLoaderOfObject(Object o) {
    if (o == null) {
      throw new NullPointerException("Argument cannot be null");
    }
    return getClassLoaderOfClass(o.getClass());
// END getClassLoaderOfObject(Object-Object)//  }
     ...
     * @return
     */
    // START getClassLoaderAsPrivileged(Class<?>-Class<?>)//public static ClassLoader getClassLoaderAsPrivileged(final Class<?> clazz) {
...
// END getClassLoaderAsPrivileged(Class<?>-Class<?>)//  }
     ...
     * @return
     */
    // START getClassLoaderOfClass(Class<?>-Class<?>)//public static ClassLoader getClassLoaderOfClass(final Class<?> clazz) {
...
// END getClassLoaderOfClass(Class<?>-Class<?>)//  }
     ...
     */
    // START loadClass(String-String)//public static Class<?> loadClass(String clazz) throws ClassNotFoundException {

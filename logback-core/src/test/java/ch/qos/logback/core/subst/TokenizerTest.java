...
public
  ...
  TokenizerTest {
    ...
    // START literalOnly({FormalParametersInternal})//@Test
...
// END literalOnly({FormalParametersInternal})//  }
	

    // START literalWithAccolades({FormalParametersInternal})//@Test
  public void literalWithAccolades() throws ScanException {
   ...
   String input2 = " - %m";
    ...
    assertEquals(witnessList, tokenList);
// END literalWithAccolades({FormalParametersInternal})//  }
	

    // START simleVariable({FormalParametersInternal})//@Test
  public void simleVariable() throws ScanException {
    ...
    witnessList.add(Token.CURLY_RIGHT_TOKEN);
    assertEquals(witnessList, tokenList);
// END simleVariable({FormalParametersInternal})//  }
	

    // START mix({FormalParametersInternal})//@Test
  public void mix() throws ScanException {
    ...
    assertEquals(witnessList, tokenList);
// END mix({FormalParametersInternal})//  }
...
// END nested({FormalParametersInternal})//  }
    ...
    // START basicDefaultSeparator({FormalParametersInternal})//@Test
  public void basicDefaultSeparator() throws ScanException {
    ...
    witnessList.add(Token.CURLY_RIGHT_TOKEN);
    assertEquals(witnessList, tokenList);
// END basicDefaultSeparator({FormalParametersInternal})//  }
	

    // START colon({FormalParametersInternal})//@Test
  public void colon() throws ScanException {
    ...
    witnessList.add(new Token(Token.Type.LITERAL, ":b"));
    assertEquals(witnessList, tokenList);
// END colon({FormalParametersInternal})//  }
	

    // /LOGBACK-744
    // START colonFollowedByDollar({FormalParametersInternal})//@Test
  public void colonFollowedByDollar() throws ScanException {
    ...
    witnessList.add(Token.CURLY_RIGHT_TOKEN);
    assertEquals(witnessList, tokenList);
// END colonFollowedByDollar({FormalParametersInternal})//  }
	

    // START defaultSeparatorOutsideVariable({FormalParametersInternal})//@Test
  public void defaultSeparatorOutsideVariable() throws ScanException {
    ...
    witnessList.add(Token.CURLY_RIGHT_TOKEN);
    assertEquals(witnessList, tokenList);
// END defaultSeparatorOutsideVariable({FormalParametersInternal})//  }

...
public
  class
  ConsoleAppenderTest  extends AbstractAppenderTest<Object>
 {
...
// END getConfiguredAppender({FormalParametersInternal})//  }
    ...
    // START testClose({FormalParametersInternal})//@Test
...
// END testClose({FormalParametersInternal})//  }
	

    // See http://jira.qos.ch/browse/LBCORE-143
    // START changeInConsole({FormalParametersInternal})//@Test
...
// END changeInConsole({FormalParametersInternal})//  }
	

    // START testUTF16BE({FormalParametersInternal})//@Test
...
// END testUTF16BE({FormalParametersInternal})//  }

...
// END setUp({FormalParametersInternal})//	}
    ...
    // START smoke({FormalParametersInternal})//@Test(timeout = 2000)
	public void smoke() {
...
// END smoke({FormalParametersInternal})//	}
    ...
    // START exceptionsShouldNotCauseHalting({FormalParametersInternal})//@Test
...
// END exceptionsShouldNotCauseHalting({FormalParametersInternal})//	}
	

    // START emptyQueueShouldBeStoppable({FormalParametersInternal})//@Test(timeout = 2000)
	public void emptyQueueShouldBeStoppable() {
		asyncAppenderBase.addAppender(listAppender);
		asyncAppenderBase.start();
		asyncAppenderBase.stop();
		verify(listAppender, 0);
// END emptyQueueShouldBeStoppable({FormalParametersInternal})//	}
	

    // START workerShouldStopEvenIfInterruptExceptionConsumedWithinSubappender({FormalParametersInternal})//@Test(timeout = 2000)
...
// END workerShouldStopEvenIfInterruptExceptionConsumedWithinSubappender({FormalParametersInternal})//	}
	

    // START noEventLoss({FormalParametersInternal})//@Test(timeout = 2000)
...
// END noEventLoss({FormalParametersInternal})//	}
	

    // START lossyAppenderShouldOnlyLooseCertainEvents({FormalParametersInternal})//@Test(timeout = 2000)
...
// END lossyAppenderShouldOnlyLooseCertainEvents({FormalParametersInternal})//	}
	

    // START lossyAppenderShouldBeNonLossyIfDiscardingThresholdIsZero({FormalParametersInternal})//@Test(timeout = 2000)
	public void lossyAppenderShouldBeNonLossyIfDiscardingThresholdIsZero() {
		...
		lossyAsyncAppender.stop();
		verify(delayingListAppender, loopLen);
// END lossyAppenderShouldBeNonLossyIfDiscardingThresholdIsZero({FormalParametersInternal})//	}
	

    // START invalidQueueCapacityShouldResultInNonStartedAppender({FormalParametersInternal})//@Test
...
// END invalidQueueCapacityShouldResultInNonStartedAppender({FormalParametersInternal})//	}
	

    // START workerThreadFlushesOnStop({FormalParametersInternal})//@SuppressWarnings("deprecation")
	@Test
	public void workerThreadFlushesOnStop() {
		...
		verify(la, loopLen);
// END workerThreadFlushesOnStop({FormalParametersInternal})//	}
	

    // START stopExitsWhenMaxRuntimeReached({FormalParametersInternal})//@SuppressWarnings("deprecation")
	@Test
	public void stopExitsWhenMaxRuntimeReached() throws InterruptedException {
		...
		// enough
		verify(la, loopLen);
// END stopExitsWhenMaxRuntimeReached({FormalParametersInternal})//	}
    ...
    // START verifyInterruptionIsNotSwallowed({FormalParametersInternal})//@Test
	public void verifyInterruptionIsNotSwallowed() {
		...
		Thread.interrupted();
// END verifyInterruptionIsNotSwallowed({FormalParametersInternal})//	}
	

    // START verifyInterruptionOfWorkerIsSwallowed({FormalParametersInternal})//@Test
	public void verifyInterruptionOfWorkerIsSwallowed() {
      asyncAppenderBase.addAppender(delayingListAppender);
	  asyncAppenderBase.start();
	  asyncAppenderBase.stop();
	  assertFalse(asyncAppenderBase.worker.isInterrupted());
// END verifyInterruptionOfWorkerIsSwallowed({FormalParametersInternal})//	}
	

    // START verify(ListAppender<Integer>-ListAppender<Integer>-int-int)//private void verify(ListAppender<Integer> la, int expectedSize) {
...
// END verify(ListAppender<Integer>-ListAppender<Integer>-int-int)//	}
	

    static
  class
  LossyAsyncAppender  extends AsyncAppenderBase<Integer>
 {
		
        // START isDiscardable(Integer-Integer)//@Override
		protected boolean isDiscardable(Integer i) {
			return (i % 3 == 0);
// END isDiscardable(Integer-Integer)//		}

...
// END setUp({FormalParametersInternal})//  }
    ...
    // START manual({FormalParametersInternal})//@Test
  @Ignore
...
// END manual({FormalParametersInternal})//  }
...
// END smoke({FormalParametersInternal})//  }
    ...
    // START closeLogFileOnPurpose({FormalParametersInternal})//private void closeLogFileOnPurpose() throws IOException {
    ResilientFileOutputStream resilientFOS = (ResilientFileOutputStream) fa
      .getOutputStream();
    FileChannel fileChannel = resilientFOS.getChannel();
    fileChannel.close();
// END closeLogFileOnPurpose({FormalParametersInternal})//  }
...
class
  Runner  extends RunnableWithCounterAndDone
 {
    ...
    // START Runner(FileAppender<Object>-FileAppender<Object>)//Runner(FileAppender<Object> fa) {
    this.fa = fa;
// END Runner(FileAppender<Object>-FileAppender<Object>)//  }

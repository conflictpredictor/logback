...
public
  class
  PatternLayout  extends PatternLayoutBase<IAccessEvent>
 {
    ...
    // START PatternLayout({FormalParametersInternal})//public PatternLayout() {
...
// END PatternLayout({FormalParametersInternal})//  }
	

    /**
     * Returns the default converter map for this instance.
     */
    // START getDefaultConverterMap({FormalParametersInternal})//@Override
  public Map<String, String> getDefaultConverterMap() {
    return defaultConverterMap;
// END getDefaultConverterMap({FormalParametersInternal})//  }
	

    // START doLayout(IAccessEvent-IAccessEvent)//@Override
  public String doLayout(IAccessEvent event) {
    if (!isStarted()) {
      return null;
    }
    return writeLoopOnConverters(event);
// END doLayout(IAccessEvent-IAccessEvent)//  }
...
// END start({FormalParametersInternal})//  }
    ...
    // START getPresentationHeaderPrefix({FormalParametersInternal})//@Override

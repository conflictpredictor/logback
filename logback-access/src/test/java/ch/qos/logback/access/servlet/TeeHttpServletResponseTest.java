...
public
  ...
  TeeHttpServletResponseTest {
    ...
    // START TeeHttpServletResponseTest(String-String-String-String-byte[]-byte[])//public TeeHttpServletResponseTest(String characterEncoding, String testString, byte[] expectedBytes) {
    this.characterEncoding = characterEncoding;
    this.testString = testString;
    this.expectedBytes = expectedBytes;
// END TeeHttpServletResponseTest(String-String-String-String-byte[]-byte[])//  }
    ...
    // START testWriterEncoding({FormalParametersInternal})//@Test
...
// END testWriterEncoding({FormalParametersInternal})//  }

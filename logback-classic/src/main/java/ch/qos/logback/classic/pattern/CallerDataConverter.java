...
public
  class
  CallerDataConverter  extends ClassicConverter
 {
    ...
    // START isRange(String-String)//private boolean isRange(String depthStr) {
    return depthStr.contains(getDefaultRangeDelimiter());
// END isRange(String-String)//  }
	

    // START splitRange(String-String)//private String[] splitRange(String depthStr) {
    return depthStr.split(quote(getDefaultRangeDelimiter()), 2);
// END splitRange(String-String)//  }
	

    // START checkRange({FormalParametersInternal})//private void checkRange() {
...
// END checkRange({FormalParametersInternal})//  }
...
// END addEvaluator(EventEvaluator<ILoggingEvent>-EventEvaluator<ILoggingEvent>)//  }
    ...
    // START convert(ILoggingEvent-ILoggingEvent)//public String convert(ILoggingEvent le) {
...
// END convert(ILoggingEvent-ILoggingEvent)//  }
    ...
    // START getCallerLinePrefix({FormalParametersInternal})//protected String getCallerLinePrefix() {
    return DEFAULT_CALLER_LINE_PREFIX;
// END getCallerLinePrefix({FormalParametersInternal})//  }
	

    // START getDefaultRangeDelimiter({FormalParametersInternal})//protected String getDefaultRangeDelimiter() {
    return DEFAULT_RANGE_DELIMITER;
// END getDefaultRangeDelimiter({FormalParametersInternal})//  }

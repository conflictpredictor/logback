...
// END tearDown({FormalParametersInternal})//  }
    ...
    // START setMockServerAndConfigure(int-int-String-String)//public void setMockServerAndConfigure(int expectedCount, String suffixPattern)
...
// END setMockServerAndConfigure(int-int-String-String)//  }
	

    // START setMockServerAndConfigure(int-int)//public void setMockServerAndConfigure(int expectedCount)
	      throws InterruptedException {
	 this.setMockServerAndConfigure(expectedCount, "[%thread] %logger %msg");   
// END setMockServerAndConfigure(int-int)//  }
	

    // START basic({FormalParametersInternal})//@Test
...
// END basic({FormalParametersInternal})//  }
	

    // START suffixPatternWithTag({FormalParametersInternal})//@Test
...
// END suffixPatternWithTag({FormalParametersInternal})//  }
	

    // START tException({FormalParametersInternal})//@Test
  public void tException() throws InterruptedException {
    ...
    checkRegexMatch(msg, regex);
// END tException({FormalParametersInternal})//  }
	

    // START checkRegexMatch(String-String-String-String)//private void checkRegexMatch(String s, String regex) {
    assertTrue("The string [" + s + "] did not match regex [" + regex + "]", s
        .matches(regex));
// END checkRegexMatch(String-String-String-String)//  }
	

    // START large({FormalParametersInternal})//@Test
  public void large() throws Exception {
    ...
    String regex = SYSLOG_PREFIX_REGEX + "\\[" + threadName + "\\] " + loggerName
        + " " + logMsg;
    checkRegexMatch(msg, regex);
// END large({FormalParametersInternal})//  }
	

    // START LBCLASSIC_50({FormalParametersInternal})//@Test
  public void LBCLASSIC_50() throws JoranException {
    ...
    logger.info("hello");
// END LBCLASSIC_50({FormalParametersInternal})//  }
	

    // START unknownHostShouldNotCauseStopToFail({FormalParametersInternal})//@Test
  public void unknownHostShouldNotCauseStopToFail() {
    ...
    sa.start();
    sa.stop();
// END unknownHostShouldNotCauseStopToFail({FormalParametersInternal})//  }

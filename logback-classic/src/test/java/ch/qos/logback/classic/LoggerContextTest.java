...
// END setUp({FormalParametersInternal})//  }
    ...
    // START testRootGetLogger({FormalParametersInternal})//@Test
...
// END testRootGetLogger({FormalParametersInternal})//  }
	

    // START testLoggerX({FormalParametersInternal})//@Test
...
// END testLoggerX({FormalParametersInternal})//  }
	

    // START testNull({FormalParametersInternal})//@Test
...
// END testNull({FormalParametersInternal})//  }
	

    // START testEmpty({FormalParametersInternal})//@Test
...
// END testEmpty({FormalParametersInternal})//  }
	

    // START testDotDot({FormalParametersInternal})//@Test
...
// END testDotDot({FormalParametersInternal})//  }
	

    // START instanceCount({FormalParametersInternal})//int instanceCount() {
    return lc.getLoggerList().size();
// END instanceCount({FormalParametersInternal})//  }
	

    // START testLoggerXY({FormalParametersInternal})//@Test
  public void testLoggerXY() {
    ...
    assertEquals(x, x2);
    assertEquals(3, instanceCount());
// END testLoggerXY({FormalParametersInternal})//  }
	

    // START testLoggerMultipleChildren({FormalParametersInternal})//@Test
...
// END testLoggerMultipleChildren({FormalParametersInternal})//  }
	

    // START testMultiLevel({FormalParametersInternal})//@Test
...
// END testMultiLevel({FormalParametersInternal})//  }
	

    // START testStatusWithUnconfiguredContext({FormalParametersInternal})//@Test
  public void testStatusWithUnconfiguredContext() {
    ...
    assertTrue("StatusManager has recieved too many messages",
            sm.getCount() == 1);
// END testStatusWithUnconfiguredContext({FormalParametersInternal})//  }
	

    // START resetTest({FormalParametersInternal})//@Test
...
// END resetTest({FormalParametersInternal})//  }
	

    // http://jira.qos.ch/browse/LBCLASSIC-89
    // START turboFilterStopOnReset({FormalParametersInternal})//@Test
...
// END turboFilterStopOnReset({FormalParametersInternal})//  }
	

    // START resetTest_LBCORE_104({FormalParametersInternal})//@Test
...
// END resetTest_LBCORE_104({FormalParametersInternal})//  }
	

    // START levelResetTest({FormalParametersInternal})//@Test
  public void levelResetTest() {
    ...
    assertTrue(root.isDebugEnabled());
// END levelResetTest({FormalParametersInternal})//  }
	

    // START evaluatorMapPostReset({FormalParametersInternal})//@Test
  public void evaluatorMapPostReset() {
    lc.reset();
    assertNotNull(lc.getObject(CoreConstants.EVALUATOR_MAP));
// END evaluatorMapPostReset({FormalParametersInternal})//  }
	

    // http://jira.qos.ch/browse/LOGBACK-142
    // START concurrentModification({FormalParametersInternal})//@Test
...
// END concurrentModification({FormalParametersInternal})//  }

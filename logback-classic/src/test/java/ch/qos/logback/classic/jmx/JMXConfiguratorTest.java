...
// END toString({FormalParametersInternal})//  }
    ...
    // START contextReset({FormalParametersInternal})//@Test
...
// END contextReset({FormalParametersInternal})//  }
	

    // START contextStop({FormalParametersInternal})//@Test
...
// END contextStop({FormalParametersInternal})//  }
	

    // START testNonRemovalOfPreviousIntanceFromTheContextListenerList({FormalParametersInternal})//@Test
...
// END testNonRemovalOfPreviousIntanceFromTheContextListenerList({FormalParametersInternal})//  }
	

    // START getLoggerLevel_LBCLASSIC_78({FormalParametersInternal})//@Test
...
// END getLoggerLevel_LBCLASSIC_78({FormalParametersInternal})//  }
	

    // START setLoggerLevel_LBCLASSIC_79({FormalParametersInternal})//@Test
  public void setLoggerLevel_LBCLASSIC_79() {
    ...
    MBeanUtil.unregister(lc, mbs, on, this);
// END setLoggerLevel_LBCLASSIC_79({FormalParametersInternal})//  }

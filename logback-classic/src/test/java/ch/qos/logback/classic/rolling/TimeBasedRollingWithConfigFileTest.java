...
public
  class
  TimeBasedRollingWithConfigFileTest  extends ScaffoldingForRollingTests
 {
...
// END loadConfig(String-String)//  }
    ...
    // START addExpectedFileNamedIfItsTime(String-String-String-String-boolean-boolean)//void addExpectedFileNamedIfItsTime(String testId, String msg,
                                     boolean gzExtension) {
...
// END addExpectedFileNamedIfItsTime(String-String-String-String-boolean-boolean)//  }
	

    // START addExpectedFileName(String-String-Date-Date-int-int-boolean-boolean)//void addExpectedFileName(String testId, Date date, int fileIndexCounter,
                           boolean gzExtension) {
...
// END addExpectedFileName(String-String-Date-Date-int-int-boolean-boolean)//  }
	

    // START addExpectedFileNamedIfItsTime_ByDate(String-String-String-String-boolean-boolean)//@Override
